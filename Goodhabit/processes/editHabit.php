			  ...
			  <div class='card-body h3 text-dark'>
				<form id='form-edit'>
				  <div class='form-group'>
					<label for='nama_keb' class='form-control-label' style='padding-left: 22px;'>Name</label><br>
					<div style='text-align: center;'>
					  <input class='form-control' type='text' value='{$result['nama_kebiasaan']}' name='nama_keb' required><br>
					</div>
				  </div>
				  <div class='form-group'>
				  ...
				  <div class='form-group'>
					<label for='time' class='form-control-label' style='padding-left: 22px;'>Time</label><br>
					<div style='text-align: center;'>
					  <input class='form-control' type='time' value='{$result['waktu']}' name='time' required><br>
					</div>
				  </div>
				  <div class='form-group'>
					<label class='form-control-label' style='padding-left: 22px;'>Repeat</label><br>
					<div style='text-align: center;'>
				  ...
				  <div id='options'>".
				  (($result['ulang'] == "tiap minggu") ? "<div class='form-group'><label class='form-control-label' style='padding-left: 22px;'>Select a day</label><br><div style='text-align: center;'><select class='form-control form-control-sm' id='option' name='option' style='height: 46px;' required>$opt</select><br></div></div>" : (($result['ulang'] == "tiap bulan") ? "<div class='form-group'><label class='form-control-label' style='padding-left: 22px;'>Select a date</label><br><div style='text-align: center;'><input class='form-control' type='number' min='1' max='31' value='{$result['ket']}' id='option' name='option'><br></div></div>" : "")).
				  "</div>
				  <div class='form-group'>
					<div class='row pt-3 vercenter'>
