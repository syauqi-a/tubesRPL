function showHabbit(key='', sbTime=''){
	if (getCookie("id_akun") != null) {
		...
		xhttp.open("GET", "../processes/getHabit.php?key="+key+"&sortByTime="+sbTime, true);
		xhttp.send();
	}
}
